      ...
      return knex('projects').insert([
        {
          ...
          tech_used: 'RESTful Architecture, AJAX, OKTA,JAVASCRIPT, MATERIAL-UI, REACT, NODE, EXPRESS, POSTGRESQL, AWS AMPLIFY, AWS ELASTIC BEANSTALK',
        ...
        },
        {
          ...
          project_desc: 'Reactjs implementation of John Conway’s game of life. Created an algorithm that evaluates each active cell and allows for that cell to live or die based on the Game of Life rules.',
          tech_used: 'CSS, JavaScript, React, Git, Vercel( formely Zeit)',
          project_url: 'https://game-of-life-sage.vercel.app/',
        ...
        },
        {
          ...
          tech_used: 'CSS, JavaScript, AJAX, React, Custom Hooks, Node, Express, SQLite, Knex, Git, Vercel( formely Zeit)',
        ...
        },
        {
          ...
          tech_used: 'CSS, JavaScript, Axios, AJAX, React, React Router, Redux, JWT, Git, Vercel( formely Zeit)',
        ...
        },
        {
          ...
          tech_used: 'CSS, JavaScript, Axios, AJAX, React, React Router, Particle.js, Git, Vercel( formely Zeit)',
        ...
        },
        {
          ...
          project_desc: 'Web App that fetches user(s) information from the Github API and presents it in a simplified and more pleasing theme. The content lazy loads and provides endless scrolling. You can search for any github user on the platform, see their information, public repos, and followers',
          tech_used: 'CSS, JavaScript, AJAX, React, React Router, Redux, Git, Vercel( formely Zeit)',
        ...
        },
        {
          ...
          tech_used: 'React, Redux, Custom React Hooks, CSS, Javascript, Git, Vercel( formely Zeit)',
